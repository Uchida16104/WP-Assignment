...
// ログイン画面のロゴ変更
function login_logo() {
  echo '<style type="text/css">.login h1 a {background-image: url("https://portal.dc-itex.com/wp-content/uploads/2022/02/logo.svg");width:300px;height:80px;background-size:contain;}.login form {border: none;}.wp-core-ui .button-group.button-large .button, .wp-core-ui .button.button-large {width: 100%;background: #e9472d;border: none;margin-top: 10px;}.login #login_error, .login .message, .login .success {border-color: #ddd;}.dashicons-visibility:before {color: #e9482d;}.login h1 a {margin-bottom: 0;margin-top: 80px;}.login label {font-weight: 700;letter-spacing: 0.05em;margin-bottom: 4px;}.wp-core-ui .button, .wp-core-ui .button-secondary {color: #fff;border: none;background: #e9482d;margin-top: 5px;}.login #backtoblog a:hover, .login #nav a:hover, .login h1 a:hover {color: #e9482d;}.login #nav{display:none}.language-switcher{display:none}</style>';
}
...
function disable_author_archive(){
    if(($_GET['author'] && !is_admin()) || preg_match('#/(author)/.+#', $_SERVER['REQUEST_URI'])){
